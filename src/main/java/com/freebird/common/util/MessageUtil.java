...
public class MessageUtil {
	...
	public static Map<String, String> parseXmlFromStream(InputStream inputStream) throws Exception {
		Map<String, String> map = new HashMap<String, String>();
		// 读取输入流
	 ...
	 * @return xml
	 */
	public static String commonOrderParamsToXml(SortedMap<Object, Object> parameters) {
